...
> Tracks **why** decisions changed and what was learned. Not a duplicate of roadmap.json — roadmap records what was decided, this records the evolution and lessons.
>
...
- Tag in brackets = greppable domain (e.g., [auth], [markets], [db], [deploy]).
